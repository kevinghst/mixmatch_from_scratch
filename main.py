...
parser.add_argument('--data_domain', default='', type=str)
parser.add_argument('--dev_mismatch', action='store_true')
parser.add_argument('--test_mode', action='store_true')
parser.add_argument('--test_dev', action='store_true')
parser.add_argument('--test_also', action='store_true')
parser.add_argument('--test_path', default='none', type=str)
parser.add_argument('--test_out_domain', action='store_true')
parser.add_argument('--stress_test', default='', type=str)
parser.add_argument('--test_in_domain', action='store_true')
parser.add_argument('--test_contrastive', action='store_true')
parser.add_argument('--test_generate', action='store_true')
